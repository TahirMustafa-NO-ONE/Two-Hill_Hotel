...
export const bookings = [
  // CABIN 001
  {
    ...
    hasBreakfast: true,
    observations:
      'Would prefer a dairy-free breakfast option if available.',
    isPaid: false,
    numGuests: 1,
  },
  {
  ...
  },
  {
    ...
    guestId: 9,
    hasBreakfast: false,
    observations: 'Traveling with our cat, hope that works!',
    isPaid: true,
    numGuests: 3,
  },
  {
  ...
  // CABIN 006
  {
    ...
    hasBreakfast: false,
    observations:
      "Arriving late in the evening, approximately 11 PM. Thanks for understanding!",
    isPaid: true,
    numGuests: 6,
  },
  {
    ...
    guestId: 18,
    hasBreakfast: true,
    observations: 'Could we get an extra folding bed for our nephew?',
    isPaid: true,
    numGuests: 4,
  },
  {
  ...
  // CABIN 008
  {
    ...
    hasBreakfast: true,
    observations:
      'One of our guests has celiac disease, would appreciate gluten-free breakfast options.',
    isPaid: true,
    numGuests: 9,
  },
  {
    ...
    hasBreakfast: true,
    observations:
      'Celebrating our 10th wedding anniversary - any special touches would be amazing!',
    isPaid: true,
    numGuests: 10,
  },
  {
